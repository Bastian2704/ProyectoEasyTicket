...
namespace ProyectoEasyTicket.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public ReviewsController(ProyectoEasyTicketContext context)
        {
            _context = context;
        }
        ...
        {
            var proyectoEasyTicketContext = _context.Reviews.Include(r => r.Ticket);
            return View(await proyectoEasyTicketContext.ToListAsync());
        }
